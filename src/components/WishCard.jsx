...
const WishCard = ({ book }) => {
    ...
    return (
        <div className="card lg:card-side bg-base-100 p-3 border rounded-2xl border-base-300 my-4">
            <div className="lg:w-1/6 flex flex-col justify-center items-center bg-[#1313130D] rounded-xl">
                <figure><img className="w-32 h-40" src={img} alt="Album" /></figure>
            </div>
            <div className="card-body space-y-2">
                <h2 className="card-title text-2xl">{title}</h2>
                <p className="font-semibold">By : {author}</p>
                <div className="lg:flex gap-6 space-y-2 items-center text-lg font-bold">
